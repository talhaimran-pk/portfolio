            ...
            <Col md={12} className="home-header">
              <div className="content-container">
                <h1 className="heading">
                 Hi, I'm <strong className="main-name">Talha Imran</strong>.
                </h1>
                ...
                <div className="paragraph-container">
                  <p>
                    A self-driven and determined individual with a passion for <span className="teal">Computer Science</span>.
                    <br /> Committed to learn new things.
                  </p>
                </div>
              <Col md={12}>
                <div>
                  <ul className="home-about-social-links">
                    <li className="social-icons">
                      <a
                        href="https://github.com/talhaimran-pk"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <li className="social-icons">
                      <a
                        href="https://www.linkedin.com/in/talhaimran-pk"
                        rel="noreferrer"
                        target="_blank"
                        className="icon-colour  home-social-icons"
                      >
